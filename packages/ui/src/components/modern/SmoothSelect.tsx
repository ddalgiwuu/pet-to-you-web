...
import { fadeVariants, slideFromRight } from '../../lib/animations';
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-12 w-full items-center justify-between glass-panel px-4 py-2 transition-all',
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-50 max-h-96 min-w-[8rem] overflow-hidden glass-modal',
...
export type SmoothSelectProps = ComponentPropsWithoutRef<typeof Select>;
